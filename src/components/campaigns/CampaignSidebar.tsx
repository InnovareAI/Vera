            ...
            <nav className="flex-1 p-4">
                ...
                <div className="mt-8 p-4 bg-gray-800/50 rounded-xl border border-gray-700/50">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                        ...
                        {/* Instagram */}
                        <div className="w-9 h-9 bg-gradient-to-br from-[#833AB4]/10 via-[#FD1D1D]/10 to-[#F77737]/10 rounded-lg flex items-center justify-center group hover:from-[#833AB4]/20 hover:via-[#FD1D1D]/20 hover:to-[#F77737]/20 transition-colors cursor-pointer" title="Instagram">
                        ...
                        {/* Facebook */}
                        <div className="w-9 h-9 bg-[#1877F2]/10 rounded-lg flex items-center justify-center group hover:bg-[#1877F2]/20 transition-colors cursor-pointer" title="Facebook">
                            <svg className="w-5 h-5 text-[#1877F2]" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                            </svg>
                        </div>
                        {/* YouTube */}
                        <div className="w-9 h-9 bg-[#FF0000]/10 rounded-lg flex items-center justify-center group hover:bg-[#FF0000]/20 transition-colors cursor-pointer" title="YouTube">
                        ...
                        {/* Reddit */}
                        <div className="w-9 h-9 bg-[#FF4500]/10 rounded-lg flex items-center justify-center group hover:bg-[#FF4500]/20 transition-colors cursor-pointer" title="Reddit">

  ...
  try {
    ...
    const htmlBody = `
      <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #3b82f6;">VERA SEO/GEO Analysis Report</h1>
        ...
        <hr />
        <p style="color: #6b7280; font-size: 12px;">Generated by VERA | InnovareAI</p>
      </div>
    `

    await sendEmail({
      to,
      subject: `VERA SEO/GEO Report: ${analysis.domain} — Score ${analysis.overall_score}/100`,
      htmlBody,
    })

    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-400 mt-4 font-medium">Loading Cold Email...</p>
        </div>
      </div>
    )
  }
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-12">
        ...
        <div className="bg-neutral-900/20 border border-neutral-800/50 rounded-xl p-10">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-semibold text-neutral-100">Campaigns</h3>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <h4 className="text-xl font-semibold text-neutral-100 mb-2">No campaigns yet</h4>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-neutral-800/50 hover:bg-transparent">
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-6">Name</TableHead>
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-4">Status</TableHead>
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-4 text-right">Sent</TableHead>
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-4 text-right">Opens</TableHead>
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-4 text-right">Clicks</TableHead>
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-4 text-right">Bounces</TableHead>
                    <TableHead className="text-neutral-500 font-bold uppercase tracking-widest text-xs py-4 px-4 text-right">Created</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {campaigns.map((campaign) => {
                    ...
                    return (
                      <TableRow
                        key={campaign.id}
                        className="border-neutral-800/50 cursor-pointer hover:bg-neutral-800/30 transition-colors"
                        onClick={() => router.push(`/cold-email/${campaign.id}`)}
                      >
                        <TableCell className="py-4 px-6">
                          <div>
                            <span className="font-bold text-neutral-100">{campaign.name}</span>
                            <p className="text-xs text-neutral-500 mt-0.5 truncate max-w-xs">{campaign.subject}</p>
                          </div>
                        </TableCell>
                        ...
                        <TableCell className="py-4 px-4 text-right font-mono text-sm text-neutral-300">
                        ...
                        <TableCell className="py-4 px-4 text-right text-sm text-neutral-500">

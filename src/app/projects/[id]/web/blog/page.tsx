...
export default function WebBlogPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">Blog Posts</h2>
        <p className="text-neutral-500 text-sm">Create SEO-optimized blog content with the AIO Blog Machine</p>
      </div>
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center max-w-sm">
          <div className="w-16 h-16 mx-auto mb-5 rounded-xl bg-sky-500/10 border border-sky-500/20 flex items-center justify-center">
          ...
          <h3 className="text-neutral-100 font-medium text-sm mb-1.5">Create Your First Blog Post</h3>
          <p className="text-neutral-600 text-xs leading-relaxed">Generate authority-building blog content optimized for search engines and AI discovery.</p>
        </div>
      </div>
    </div>
  )

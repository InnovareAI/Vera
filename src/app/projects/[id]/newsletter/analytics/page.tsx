...
export default function NewsletterAnalyticsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-black text-white mb-1">Newsletter Analytics</h2>
        <p className="text-gray-500 text-sm">Open rates, click rates, growth, and engagement trends</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <h3 className="text-white font-bold text-sm mb-1.5">Send newsletters to see analytics</h3>
          <p className="text-gray-600 text-xs leading-relaxed">Newsletter performance data will appear once you start sending.</p>
        </div>
      </div>
    </div>
  )

      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 hover:border-neutral-700 transition-all">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Top Performers</p>
          </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 hover:border-neutral-700 transition-all">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Repurpose</p>
          </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 hover:border-neutral-700 transition-all">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Ad Candidates</p>
          </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 hover:border-neutral-700 transition-all">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Plan More</p>
          </div>
              ...
              <div key={item.id} className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden hover:border-neutral-700 transition-all">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-bold text-neutral-100 truncate">{item.title}</p>
                  </div>
                  ...
                  <div className="hidden sm:flex items-center gap-6">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-bold text-neutral-100">{item.engagement.impressions.toLocaleString()}</p>
                ...
                {isExpanded && (
                  <div className="px-5 pb-5 border-t border-neutral-800/50">
                    ...
                    <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-3">Amplification Actions</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-sm font-bold text-neutral-100">Signal Overlap Detected</p>
            ...
            <div className="p-4 rounded-xl bg-neutral-950 border border-neutral-800/50">
              <p className="text-sm text-neutral-300 leading-relaxed">
                <span className="text-amber-400 font-bold">&quot;AI SDR&quot;</span> is both your highest-performing topic <span className="text-neutral-500">(8.2% engagement)</span> and a rising competitor angle <span className="text-neutral-500">(3x/week from Competitor A)</span>. This overlap signals strong market demand — amplify aggressively before the angle saturates.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="flex items-center gap-1.5 text-[10px] text-neutral-600">
                <div className="w-2 h-2 rounded-full bg-neutral-500" /> Suggested
              </span>
            </div>
          </div>
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
            {AMPLIFICATION_QUEUE.map((item, i) => (
              <div key={i} className={`flex items-center gap-4 p-5 ${i < AMPLIFICATION_QUEUE.length - 1 ? 'border-b border-neutral-800/50' : ''} hover:bg-neutral-800/20 transition-all`}>
                ...
                {/* Content + action */}
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-neutral-100 truncate">{item.content}</p>
                ...
                {/* Action button */}
                <button className="px-3.5 py-2 rounded-lg bg-neutral-800 border border-neutral-700 text-xs font-bold text-neutral-300 hover:bg-neutral-700 hover:text-neutral-100 transition-all flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.step} className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-neutral-100">{s.title}</p>

...
export default function NurtureAnalyticsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">Email Performance</h2>
        <p className="text-neutral-500 text-sm">Open rates, click rates, replies, and conversion tracking</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <h3 className="text-neutral-100 font-medium text-sm mb-1.5">Send emails to see analytics</h3>
          <p className="text-neutral-600 text-xs leading-relaxed">Email performance metrics will appear here once sequences are active.</p>
        </div>
      </div>
    </div>
  )

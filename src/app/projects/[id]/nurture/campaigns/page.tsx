...
export default function NurtureCampaignsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">Drip Campaigns</h2>
        <p className="text-neutral-500 text-sm">Automated multi-step email campaigns with conditional logic</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <p className="text-neutral-600 text-xs leading-relaxed">Multi-step drip campaigns with conditional branching based on recipient behavior.</p>
        </div>
      </div>
    </div>
  )

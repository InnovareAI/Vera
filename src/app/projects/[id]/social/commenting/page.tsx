...
export default function SocialCommentingPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">Commenting Agent</h2>
        <p className="text-neutral-500 text-sm">AI-powered engagement on LinkedIn — discover, generate, and post on-brand comments</p>
      </div>
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center max-w-sm">
          <p className="text-neutral-600 text-xs">Configure monitors and brand voice in project settings to activate the commenting agent for this project.</p>
        </div>
      </div>
    </div>
  )

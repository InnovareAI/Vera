...
export default function PaidAnalyticsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-black text-white mb-1">Ad Performance</h2>
        <p className="text-gray-500 text-sm">Track paid campaign performance across Meta and Google Ads</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <h3 className="text-white font-bold text-sm mb-1.5">Connect Ad Platforms</h3>
          <p className="text-gray-600 text-xs leading-relaxed">Connect Meta Ads and Google Ads to track campaign performance and ROI.</p>
        </div>
      </div>
    </div>
  )

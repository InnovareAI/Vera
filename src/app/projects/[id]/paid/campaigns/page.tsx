...
export default function PaidCampaignsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-black text-white mb-1">Campaign Proposals</h2>
        <p className="text-gray-500 text-sm">Structured campaign plans with targeting, budget, and ad set logic</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <p className="text-gray-600 text-xs leading-relaxed">AI-proposed campaign structures with targeting, budget allocation, and ad set logic for Meta and Google Ads.</p>
        </div>
      </div>
    </div>
  )

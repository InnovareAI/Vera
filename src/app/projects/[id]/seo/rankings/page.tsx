...
export default function SeoUrankingsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-black text-white mb-1">Urankings</h2>
        <p className="text-gray-500 text-sm">Track your search rankings over time</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <p className="text-gray-600 text-xs leading-relaxed">Connect Google Search Console to unlock rankings data.</p>
        </div>
      </div>
    </div>
  )

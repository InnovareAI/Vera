...
export default function SeoOverviewPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-black text-white mb-1">SEO & Search Overview</h2>
        <p className="text-gray-500 text-sm">Search visibility, keyword rankings, and organic traffic from Google</p>
      </div>
      ...
      <div className="p-4 rounded-xl border border-dashed border-emerald-500/20 bg-emerald-500/5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">See real search performance data for your content</p>
          </div>
        </div>
        <button className="px-4 py-2 rounded-lg border border-emerald-500/30 text-emerald-400 text-xs font-bold hover:bg-emerald-500/10 transition-all">Connect</button>
      </div>
    </div>
  )
}

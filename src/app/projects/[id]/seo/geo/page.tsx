'use client'
export default function SeoUgeoPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">Ugeo</h2>
        <p className="text-neutral-500 text-sm">Generative Engine Optimization — visibility in AI-powered search</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <p className="text-neutral-600 text-xs leading-relaxed">Connect Google Search Console to unlock geo data.</p>
        </div>
      </div>
    </div>
  )

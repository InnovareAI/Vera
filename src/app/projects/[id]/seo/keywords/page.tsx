...
export default function SeoUkeywordsPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-neutral-100 mb-1">Ukeywords</h2>
        <p className="text-neutral-500 text-sm">Keyword research and tracking for your content topics</p>
      </div>
      <div className="flex items-center justify-center py-20">
        <div className="text-center max-w-sm">
          ...
          <p className="text-neutral-600 text-xs leading-relaxed">Connect Google Search Console to unlock keywords data.</p>
        </div>
      </div>
    </div>
  )

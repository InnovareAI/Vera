        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <Link href={`/projects/${projectId}`} className="px-4 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-all">
                {name || 'Project'}
              </Link>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <Link href={`/projects/${projectId}`} className="text-gray-500 hover:text-gray-300 text-xs font-bold uppercase tracking-widest transition-colors">
                {name || 'Project'}
              </Link>
              <svg className="w-3 h-3 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
              <span className="text-violet-400 text-xs font-bold uppercase tracking-widest">Edit</span>
            </div>
            <h1 className="text-4xl font-black tracking-tight text-white">Edit Project</h1>
          </div>
        </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 max-w-md w-full space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm">
                  Are you sure you want to delete <span className="text-white font-bold">{name}</span>? This action cannot be undone. All project data, including platform configurations, will be permanently removed.
                </p>
              </div>
              <div className="flex items-center gap-3">
                <button

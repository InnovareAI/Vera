    ...
    <div className="min-h-screen bg-gray-950 text-white selection:bg-violet-500/30">
      ...
      {toast && (
        <div className="fixed top-6 right-6 z-[100] animate-in slide-in-from-top-2 fade-in">
          <div className={`px-6 py-3 rounded-2xl font-bold text-sm shadow-2xl border ${
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-12">
        ...
        <div>
          ...
          <h2 className="text-4xl font-black tracking-tight text-white mb-2">Brand Guidelines</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Quick Settings</h3>
                  <p className="text-sm text-gray-500">High-level controls for comment generation</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Tone</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Formality</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Comment Length</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Question Frequency</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Perspective Style</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Confidence Level</Label>
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Your Expertise</h3>
                  <p className="text-sm text-gray-500">Help the AI understand your background and perspective</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">What You Do</Label>
                  <Textarea
                    ...
                    className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-600 min-h-[100px] resize-none"
                  />
                </div>

                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">What You've Learned</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">POV on Future</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Industry Talking Points</Label>
                  <Textarea
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Brand Voice</h3>
                  <p className="text-sm text-gray-500">Define how your comments should sound</p>
                </div>
              </div>

              <div className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Voice Reference</Label>
                  <Input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Tone of Voice</Label>
                    <Textarea
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Writing Style</Label>
                    <Textarea
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Dos and Don'ts</Label>
                  <Textarea
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Vibe Check</h3>
                  <p className="text-sm text-gray-500">Fine-tune the personality of your comments</p>
                </div>
              </div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={item.key} className="flex items-center justify-between py-3 border-b border-gray-800/50 last:border-0">
                    <div>
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Comment Framework</h3>
                  <p className="text-sm text-gray-500">Structure how comments are composed</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Framework Preset</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Max Characters</Label>
                    <Input
                      type="number"
                    ...
                    />
                    <p className="text-gray-600 text-xs">Recommended: 200-500 characters for LinkedIn</p>
                  </div>
                </div>

                {settings.framework_preset === 'custom' && (
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Custom Framework</Label>
                    <Textarea
                      ...
                      className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-600 min-h-[120px] resize-none"
                    />
                  </div>
                )}

                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Example Comments</Label>
                  <Textarea
                    ...
                    className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-600 min-h-[140px] resize-none"
                  />
                  <p className="text-gray-600 text-xs">One example per line. These help the AI match your natural commenting style.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Guardrails</h3>
                  <p className="text-sm text-gray-500">Set boundaries the AI should never cross</p>
                </div>
              </div>

              <div className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Competitors to Never Mention</Label>
                  <Input
                    ...
                    className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-600"
                  />
                  <p className="text-gray-600 text-xs">Comma-separated list of names or brands to avoid</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">CTA Frequency</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">CTA Style</Label>
            ...
            <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">Scheduling</h3>
                  <p className="text-sm text-gray-500">Control when and how often comments are posted</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Daily Comment Limit</Label>
                  <Input
                    type="number"
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-gray-800/50">
                  <div>
                    <p className="text-white font-bold text-sm">Skip weekends</p>
                    <p className="text-gray-500 text-xs mt-0.5">Pause commenting on Saturday and Sunday</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    <p className="text-white font-bold text-sm">Skip holidays</p>
                    <p className="text-gray-500 text-xs mt-0.5">Pause commenting on major US holidays</p>
                  </div>
                  <Switch

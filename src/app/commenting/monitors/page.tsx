...
export default function MonitorsPage() {
  ...
  const statusBadge = (status: string) => {
    ...
    return <Badge variant="outline" className="border-neutral-600 text-neutral-400">Paused</Badge>
  }
    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-400 mt-4 font-medium">Loading Monitors...</p>
        </div>
      </div>
    )
  }
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="bg-neutral-900 border-neutral-800 text-neutral-100 sm:rounded-2xl max-w-lg">
              <DialogHeader>
                <DialogTitle className="text-neutral-100 text-xl font-semibold">Create Monitor</DialogTitle>
              </DialogHeader>

              <div className="space-y-5 pt-2">
                {/* Name */}
                <div>
                  <label className="text-xs font-bold text-neutral-400 uppercase tracking-widest mb-1.5 block">
                    Monitor Name
                  </label>
                  <Input
                    value={formName}
                    ...
                    className="bg-neutral-800 border-neutral-700 text-neutral-100 placeholder:text-neutral-600 rounded-xl focus:border-violet-500 focus:ring-violet-500/20"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-neutral-800 border-neutral-700 text-neutral-100 placeholder:text-neutral-600 rounded-xl focus:border-violet-500 focus:ring-violet-500/20"
                  />
                  <p className="text-neutral-600 text-xs mt-1">Comma-separated. Include # prefix or not.</p>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-neutral-800 border-neutral-700 text-neutral-100 placeholder:text-neutral-600 rounded-xl focus:border-violet-500 focus:ring-violet-500/20"
                  />
                  <p className="text-neutral-600 text-xs mt-1">Comma-separated. Used for additional filtering.</p>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-2.5 text-neutral-100 focus:outline-none focus:border-violet-500 transition-colors"
                  >
                    <option value="hashtag" className="bg-neutral-900">Hashtag</option>
                    <option value="keyword" className="bg-neutral-900">Keyword</option>
                    <option value="profile" className="bg-neutral-900">Profile</option>
                  </select>
                </div>
        ...
        {loading ? (
          ...
          <div className="bg-neutral-900/40 border border-neutral-800 rounded-xl p-16 text-center">
            ...
            <h3 className="text-2xl font-semibold text-neutral-100 mb-3">No monitors yet</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {monitors.map((monitor) => (
              <div
                key={monitor.id}
                className="bg-neutral-900/40 border border-neutral-800 rounded-xl p-6 hover:bg-neutral-900/60 transition-all group relative overflow-hidden"
              >
                {/* Decorative glow */}
                ...
                <div className="flex items-start justify-between mb-4 relative">
                  <div className="min-w-0 flex-1">
                    <h3 className="text-neutral-100 font-semibold text-lg truncate mb-1">{monitor.name}</h3>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors shrink-0 ml-3 ${
                      monitor.status === 'active' ? 'bg-violet-600' : 'bg-neutral-700'
                    }`}
                  >
                    <span
                  ...
                  {deleteConfirmId === monitor.id ? (
                    <div className="flex items-center gap-1">
                      ...
                      <Button
                        ...
                        className="text-neutral-500 hover:text-neutral-300 text-xs rounded-lg px-2"
                      >
                        Cancel
                      </Button>
                    </div>
                    ...
                    <Button
                      ...
                      className="text-neutral-500 hover:text-red-400 hover:bg-red-500/10 text-xs rounded-lg px-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

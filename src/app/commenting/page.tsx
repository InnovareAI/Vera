...
function confidenceBadge(score: number) {
  ...
  return (
    <Badge className="bg-neutral-700/50 text-neutral-400 border border-neutral-600">
      {Math.round(score * 100)}% match
    </Badge>
  )
}
...
export default function CommentingDashboard() {
    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-400 mt-4 font-medium">Loading Commenting Agent...</p>
        </div>
      </div>
    )
  }
  ...
  if (!user || !currentWorkspace) {
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center">
        <div className="text-center">
          <div className="w-20 h-20 bg-neutral-800/50 rounded-xl flex items-center justify-center mx-auto mb-6">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <h1 className="text-5xl font-semibold tracking-tight text-neutral-100 mb-4">
              Commenting Agent
            </h1>
          ...
          <div className="flex items-center gap-3">
            <Link href="/commenting/settings">
              <Button variant="outline" className="border-neutral-700 text-neutral-300 hover:text-neutral-100 hover:border-neutral-500 font-bold rounded-xl">
          ...
          {[
            ...
            >
              ...
              <div className="flex items-end gap-3">
                <span className="text-5xl font-semibold text-neutral-100">{loading ? '--' : stat.value}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-neutral-900/20 border border-neutral-800/50 rounded-xl p-10">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-2xl font-semibold text-neutral-100">Pending Comments</h3>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center">
                  <div className="w-24 h-24 bg-neutral-800/50 rounded-xl flex items-center justify-center mb-6">
                  ...
                  <h4 className="text-xl font-semibold text-neutral-100 mb-2">No pending comments</h4>
                ...
                <div className="space-y-4">
                  {pending.map((comment) => (
                    <div
                      key={comment.id}
                      className="bg-neutral-900/40 border border-neutral-800 rounded-2xl p-6 hover:bg-neutral-900/60 transition-all"
                    >
                      {/* Post context */}
                      <div className="flex items-center gap-2 mb-3">
                        <div className="w-8 h-8 bg-gradient-to-br from-gray-700 to-gray-600 rounded-full flex items-center justify-center text-xs font-bold text-neutral-100">
                          {comment.post_author[0]?.toUpperCase() || '?'}
                        </div>
                        <div>
                          <span className="text-sm font-bold text-neutral-100">{comment.post_author}</span>
                          {comment.monitor_name && (
                            <span className="text-xs text-neutral-600 ml-2">via {comment.monitor_name}</span>
                          )}
                        </div>
                      ...
                      {/* Generated comment */}
                      <div className="mb-4">
                        <p className="text-xs text-neutral-500 font-bold uppercase tracking-widest mb-2">Generated Reply</p>
                        <p className="text-sm text-neutral-200 leading-relaxed">{comment.generated_comment}</p>
                      </div>
                      ...
                      <div className="flex items-center gap-3 pt-2 border-t border-neutral-800/50">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="border-neutral-700 text-neutral-300 hover:text-neutral-100 hover:border-neutral-500 font-bold rounded-lg"
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="text-neutral-500 hover:text-red-400 font-bold rounded-lg"
          ...
          <div className="space-y-6">
            {/* Quick Actions */}
            <div className="bg-neutral-900/20 border border-neutral-800/50 rounded-xl p-8">
              <h3 className="text-lg font-semibold text-neutral-100 mb-6">Quick Actions</h3>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full justify-start px-5 py-3 border-neutral-700 text-neutral-300 hover:text-neutral-100 hover:border-neutral-500 font-bold rounded-xl"
            ...
            {/* Recent Activity */}
            <div className="bg-neutral-900/20 border border-neutral-800/50 rounded-xl p-8">
              <h3 className="text-lg font-semibold text-neutral-100 mb-6">Recent Activity</h3>
              ...
              {loading ? (
                ...
                <div className="text-center py-10">
                  <svg className="w-10 h-10 mx-auto text-neutral-700 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="text-neutral-500 text-sm font-medium">No activity yet</p>
                  <p className="text-neutral-600 text-xs mt-1">Posted comments will appear here.</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {posted.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-start gap-3 p-3 rounded-xl hover:bg-neutral-800/30 transition-colors"
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-bold text-neutral-100 truncate">{item.post_author}</p>
                        <p className="text-xs text-neutral-500 leading-relaxed mt-0.5 line-clamp-2">
                          {item.comment_snippet}
                        </p>
                        <p className="text-xs text-neutral-600 mt-1">{timeAgo(item.posted_at)}</p>
                      </div>
                    </div>
                  ))}
                </div>
